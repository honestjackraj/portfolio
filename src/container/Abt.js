...
const abt = () => {
  return (
         ...
         <>
      <div id='abt'>
     <div className="container text-center abt-all-down  ">
  <div className="row">
    <div className="col-6">
...
<div className='awesome'>
 ...
 <div className='resume'> <button  className='button glow-on-hover'>
  <a className='resume-name' href="https://drive.google.com/drive/folders/1uB9sfycIpWbyUeGsUfZNT45sZusamKGJ"  target="_blank" rel= "noreferrer"> 
  Download CV </a><i class="uil uil-download-alt button__icon"></i></button></div>
    ...
    <div class="col">
        ...
        <img class="abt-gif" src="https://media3.giphy.com/media/L8K62iTDkzGX6/200w.webp?cid=ecf05e47yxzvvl8hzpa9deet6fy21yc6cjshhtthom3so5te&rid=200w.webp&ct=g"
            alt=" image"/>
